    ...
    <section className="relative min-h-[888px] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          width={1000}
          height={1000}
          className="object-cover w-full h-[888px]"
        />
      </div>

      {/* Content */}
      <Container className="flex items-center min-h-[888px] justify-start relative z-10">
        <div className="grid gap-10">
          {/* Main content - takes 7 columns on desktop */}
          <motion.div
