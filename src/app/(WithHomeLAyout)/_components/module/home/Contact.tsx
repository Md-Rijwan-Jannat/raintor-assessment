            ...
            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
              ...
              >
                <motion.button
                  ...
                  className="relative overflow-hidden flex items-center cursor-pointer ring-1 ring-white rounded-full font-medium pr-3 py-2 text-[18px] gap-1.5 bg-transparent text-white hover:bg-white/5 shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  whileHover={
                    !isSubmitting
                      ? {
                          scale: 1.05,
                ...
                <motion.button
                  type="button"
                  className="relative overflow-hidden flex items-center cursor-pointer ring-1 ring-white rounded-full font-medium pr-3 py-2 text-[18px] gap-1.5 bg-transparent text-white hover:bg-white/5 shadow-lg hover:shadow-xl transition-all duration-300"
                  whileHover={{
                    scale: 1.05,
                ...
                <div className="flex items-center gap-4">
                  {[
                    ...
                    <motion.a
                      key={social.name}
                      href="#"
                      className="text-white hover:text-gray-300 transition-colors p-2 rounded-full hover:bg-white/5"
